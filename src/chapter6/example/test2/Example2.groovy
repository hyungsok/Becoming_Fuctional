package chapter6.example.test2
...
class Customer {
    ...
    @Lazy
    volatile Double revenue = calculateRevenue(this.contracts)
...
class CustomerContainer {
    public List<chapter6.example.test1.Customer> customers = []
    public List<chapter6.example.test1.Customer> onlyEnabled = []
